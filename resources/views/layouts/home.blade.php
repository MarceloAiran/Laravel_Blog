                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Novo Usuário</a>
                                </li>
                                <li>
                                    <a href="morris.html">Listar Usuários</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Perfil</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i>Categiria</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-link fa-fw"></i>Tag</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Settings Blog<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/layouts/pages/panels-wells.html">Panels and Wells</a>
                                </li>
                                <li>
                                    <a href="/layouts/pages/buttons.html">Buttons</a>
                                </li>
                                <li>
                                    <a href="/layouts/pages/notifications.html">Notifications</a>
                                </li>
                                <li>
                                    <a href="/layouts/pages/typography.html">Typography</a>
                                </li>
                                <li>
                                    <a href="/layouts/pages/icons.html"> Icons</a>
                                </li>
                                <li>
                                    <a href="/layouts/pages/grid.html">Grid</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
